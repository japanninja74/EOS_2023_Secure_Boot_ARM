...
*                                               MODULE
*
* Note(s) : (1) This Clock module header file is protected from multiple pre-processor inclusion
*               through use of the Clock module present pre-processor macro definition.
*********************************************************************************************************
*/
...
#define  CLK_VERSION                                     309u   /* See Note #1.                                         */
...
*
*               (b) \<uC/CLK>\Source\clk.h
*                                   \clk.c
*
*               (c) \<uC/CLK>\OS\<os>\clk_os.c
*
*                       where
*                               <Your Product Application>      directory path for Your Product's Application
*                               <uC/CLK>                        directory path for Clock module (uC/CLK)
...
#define  CLK_EPOCH_YR_END                               2135u   /*           ends   = 2134-12-31 23:59:59 UTC.          */
...
#define  CLK_NTP_EPOCH_YR_END                           2035u   /*           ends   = 2034-12-31 23:59:59 UTC.          */
...
#define  CLK_TRACE_INFO(x)                    ((CLK_TRACE_LEVEL >= TRACE_LEVEL_INFO) ? (void)(CLK_TRACE x) : (void)0)
#define  CLK_TRACE_DBG(x)                     ((CLK_TRACE_LEVEL >= TRACE_LEVEL_DBG)  ? (void)(CLK_TRACE x) : (void)0)
